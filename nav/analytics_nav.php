    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" id="navbarDropdownMenuLink-555"
          aria-haspopup="true" aria-expanded="false" href="<?php echo $baseUrl.'analytics/analytics_dashboard.php'; ?>"> Dashboard
        </a>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink-555">
          <a class="dropdown-item" href="<?php echo $baseUrl.'analytics/staff/staff_records.php'; ?>" > <i class="fas fa-users"></i> Staff Records</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink-555">
          <a class="dropdown-item" href="<?php echo $baseUrl.'analytics/student/submissions.php'; ?>"> <i class="fas fa-suitcase"></i> Submissions</a>
  ...
  <ul class="navbar-nav ml-auto nav-flex-icons">
    ...
    <li class="nav-item avatar dropdown notification-bar-item">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-xs-right dropdown-menu-sm-right dropdown-menu-lg-left dropdown-secondary"
            ...
            <a class="dropdown-item" href="<?php echo $baseUrl ?>analytics_login.php"> <i class="fas fa-sign-out-alt"></i> Logout</a>
          </div>
    </li>
  </ul>
</nav>
