      ...
      <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" id="navbarDropdownMenuLink-555"
                aria-haspopup="true" aria-expanded="false" href="<?php echo $baseUrl.'dean/profile_form.php'; ?>"> Profile Form
              </a>
            </li>
      </ul>
  </div>
  ...
  <ul class="navbar-nav ml-auto nav-flex-icons">
    ...
    <li class="nav-item avatar dropdown notification-bar-item">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left dropdown-success"
            ...
            <a class="dropdown-item" href="<?php echo $baseUrl.'dean/my_profile.php'; ?>"> <i class="far fa-user"></i> Profile</a>
