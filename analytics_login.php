...
error_reporting(E_ALL);
    ...
    session_destroy();
    session_start();
    $page_title = "Clearance Analytics Sign-in";
    // Core
    ...
    if (isset($_POST['formLogin'])){
       ...
       if ($loginUsername=='siteAnalytics' && $loginPassword=='#8A!z&84O9x')
       {
            $_SESSION['ulogin_state'] = 200;
            if (headers_sent()){
                die("<br/><br/><div class='mt-5 text-center'><big><strong>You are signed-in.</strong><br/> If not re-directed. Please click on this link: <a href='analytics/analytics_dashboard.php'>University Online Clearance Analytics/Stats Account.</a></big></div>");
            }else{
                header("location: analytics/analytics_dashboard.php");
            }
 ...
 <div class="container-fluid">
     <div class="row d-flex justify-content-center" style="margin-top:20px;">
       ...
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center">
           <h3>Clearance Analytics Online Office</h3>
       </div>
       <!-- end of top pane //-->
