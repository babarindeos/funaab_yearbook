...
// get user eligibility
  ...
  //session_start();
      ...
      // if (!(isset($_SESSION['app_login']) && $_SESSION['app_login'] != '' && $_SESSION['app_login'] == 'admin')) {
                  ...
                  <!-- end of student information //-->
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6">
                              ...
                              <form action="<?php $form_action_link; ?>" method="post">
                                      ...
                                      <div class="z-depth-2 rounded py-4 px-2 disabled" style='opacity:0.5'>
                                            Should <strong><?php echo $surname.' '.$firstname.' '.$othername; ?></strong> be Cleared?

                                                    <!-- Clearance radio button-->
                                                    <div class="mt-2 px-2">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                          <input type="radio" class="custom-control-input radClearance disabled" id="rad_cleared" name="rad_clearance" value="Y" <?php if($clearance_option=='Y'){echo 'checked';} ?> >
                                                          <label class="custom-control-label" for="rad_cleared">Cleared</label>
                                                        </div>

                                                        <!-- Default inline 2-->
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                          <input type="radio" class="custom-control-input radClearance disabled" id="rad_not_cleared" name="rad_clearance" value="N" <?php if($clearance_option=='N'){echo 'checked';} ?>>
                                                    ...
                                                    <div id="div_remark" class='mt-3' <?php echo $remark_style; ?> >
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control disabled" name="txt_remark" id="txt_remark" rows="4"><?php echo $remark; ?></textarea>
                                                            </div>
                                                    </div>
                                                    ...
                                                    <div id="div_reason" class='mt-3' <?php echo $reason_style;  ?> >
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control disabled" name="txt_reason" id="txt_reason" rows="4"><?php echo $reason; ?></textarea>
                                                            </div>
                                                    </div>
                                                    <!-- ************ Remedy *****************************************//-->
                                                    <div id="div_remedy" class='mt-3' <?php echo $remedy_style; ?> >
                                                          <div class="form-group">
                                                              ...
                                                              <textarea class="form-control disabled" name="txt_remedy" id="txt_remedy" rows="4"><?php echo $remedy; ?></textarea>
                                                          </div>
                                                    </div>
                                                    <!--************* end of Remedy *********************************//-->
                                                    ...
                                                    <div id="div_submit" class='mt-3' <?php echo $btnSubmit_style; ?>  >
                                                          <button type="submit" name="btnSubmit" class="btn btn-primary btn-rounded btn-sm disabled">Submit</button>
                                                    </div>
                                      </div>
