  ...
  <div class="container">
      ...
      <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
                <a href='register_dean_access.php' class='btn btn-sm btn-rounded btn-success'><i class="fas fa-user-plus"></i> &nbsp;Register Dean access</a>
          </div>
      </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <?php
                      ...
                      $get_registered_dean = $yearbook->get_dean_access($get_active_session);
