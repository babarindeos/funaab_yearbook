...
error_reporting(E_ALL);
    ...
    if (isset($_POST['formLogin'])){
       ...
       if ($loginUsername=='funaabprinter' && $loginPassword=='Un1ver$1ty2022!')
       {
            $_SESSION['ulogin_state'] = 200;
            if (headers_sent()){
                die("<br/><br/><div class='mt-5 text-center'><big><strong>You are signed-in.</strong><br/> If not re-directed. Please click on this link: <a href='printer/printer_dashboard.php'>FUNAAB YearBook Printer's Online Account</a></big></div>");
            }else{
                header("location: printer/printer_dashboard.php");
            }
 ...
 <div class="container-fluid">
     <div class="row d-flex justify-content-center" style="margin-top:20px;">
       ...
       <!-- top pane //-->
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center mt-5 mb-3 text-center">
           <h3><strong>FUNAAB YearBook</strong><br/>Printer's Online Office</h3>
       </div>
       <!-- end of top pane //-->
