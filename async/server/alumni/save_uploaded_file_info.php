...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH']=='XMLHttpRequest')
  {
    ...
    $alumni_receipt_no = 'alumni-receipt_'.$_POST['alumni_receipt_no'];
    $file = $_POST['file'];
    ...
    if ($alumni_receipt_no!='' && $file!='' && $matric_no!='' && $payment_description!='' && $unit_id!='' && $file_extension!='' && $file_type!='')
    {
         $dataArray = array("rrr"=>$alumni_receipt_no, "file"=>$file, "matric_no"=>$matric_no, "payment_description"=>$payment_description,
         ...
         if ($save_file_info['status']=='success'){
            //session_start();
            //unset($_SESSION['students_affairs_yearbook_receipt_uploaded']);
            $_SESSION['alumni_receipt_uploaded'] = $file;
         }
