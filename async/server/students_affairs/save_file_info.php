...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH']=='XMLHttpRequest')
  {
    ...
    $yearbook_rrr = $_POST['yearbook_rrr'];
    $file = $_POST['file'];
    ...
    if ($yearbook_rrr!='' && $file!='' && $matric_no!='' && $payment_description!='' && $unit_id!='' && $file_extension!='' && $file_type!='')
    {
         $dataArray = array("rrr"=>$yearbook_rrr, "file"=>$file, "matric_no"=>$matric_no, "payment_description"=>$payment_description,
         ...
         if ($save_file_info['status']=='success'){
            ...
            $_SESSION['students_affairs_yearbook_receipt_uploaded'] = $file;
         }
