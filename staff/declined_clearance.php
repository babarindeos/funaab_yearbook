...
<div class="table">
  <table id="tblData3" class="table table-striped">
    <thead>
      <tr>
        <th scope="col">#</th>
    ...
    <tbody>
      <?php
          if ($declined_clearance->rowCount()){
              $counter = 1;
              foreach($declined_clearance as $row){
              ...
              echo "<tr><td colspan='7'>There are currently no declined clearance forms.</td></tr>";
          }
      ?>
